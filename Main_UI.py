...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.LimitTimeFrame.setGeometry(QRect(9, 271, 1001, 161))
        ...
        self.frame.setGeometry(QRect(9, 438, 1121, 266))
        ...
        self.LimitValue.setGeometry(QRect(9, 124, 861, 141))
        ...
        self.label_11 = QLabel(self.LimitValue)
